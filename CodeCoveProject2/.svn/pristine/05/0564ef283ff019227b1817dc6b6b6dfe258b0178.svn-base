                    ...
                    <ul class="navbar-nav ms-auto">
                              ...
                              <div class="col-lg-3">
                                ...
                                <a class="d-flex align-items-center dropdown-item" href="theme-style-rtl.html">
                                  <span class="flex-center fw-bold bg-success text-white width-1x small height-1x me-2 rounded-circle shadow-lg lh-1">
                                    R
                                  </span> Theme RTL <span class="badge bg-success small ms-2">New</span>
                                </a>
                              </div>
                              <!--/.End col-->
                            </div>
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu p-lg-3 dropdown-menu-end dropdown-menu-xs">
                          ...
                          <a class="dropdown-item" target="_blank" href="https://uigator.com/assan/5.1/blog-magazine/index.html">
                       ...
                       <div class="col-md-10 col-lg-8 mx-auto text-center position-relative">
                           ...
                           <div class=" position-relative z-1">
                            ...
                            <div class="text-danger mb-5">
                              <img src="assets/img/graphics/illustration/404.svg" class="width-18x mx-auto" alt="">
                            </div>
