             ...
             <table class="table table-striped mb-0" style="width:100%">
               ...
               <tbody class="align-middle">
                 <tr>
                   <td>
                     <div class="d-flex align-items-center">
                       <a href="#!.html"><img src="/resources/assets/media/products/6.png"
                           class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                       <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Apple white
                           earbuds
                           water proof</a></p>
                     </div>
                   </td>
                 ...
                 <tr>
                   <td class="">
                     <div class="d-inline-flex align-items-center">
                       <a href="#!.html"><img src="/resources/assets/media/products/3.png"
                           class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                       <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Mini handbag for
                           woomens</a></p>
                     </div>
                   </td>
                   <td>
                 ...
                 <tr>
                   <td class="">
                     <div class="d-flex align-items-center">
                       <a href="#!.html"><img src="/resources/assets/media/products/4.png"
                           class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                       <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Minimalist
                           wireless
                           headphone</a></p>
                     </div>
                   </td>
                 ...
                 <tr>
                   <td class="">
                     <div class="d-flex align-items-center">
                       <a href="#!.html"><img src="/resources/assets/media/products/5.png"
                           class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                       <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Google alexa</a>
                       </p>
                     </div>
                   </td>
                   <td>
                 ...
                 <tr>
                   <td class="">
                     <div class="d-flex align-items-center">
                       <a href="#!.html"><img src="/resources/assets/media/products/7.png"
                           class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                       <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Lorem ipsum
                           robot</a>
                       </p>
                     </div>
                   </td>
