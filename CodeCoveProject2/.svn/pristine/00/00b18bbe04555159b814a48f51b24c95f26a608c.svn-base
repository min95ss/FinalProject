			...
			<nav class="flex-grow-1 h-100" id="page-navbar">
				...
				<ul class="nav flex-column collapse-group collapse d-flex">
					<li class="nav-item sidebar-title text-truncate opacity-50 small">
						<i class="bi bi-three-dots"></i> <span>My Page</span>
					</li>
					<li class="nav-item"><a href="/coco/profileConfirm"
						class="nav-link d-flex align-items-center text-truncate active">
							<span class="sidebar-icon"> <span
								class="material-symbols-rounded"> account_circle </span>
						</span> <!--Sidebar nav text--> <span class="sidebar-text">내 정보</span>
					</a></li>
					
					<li class="nav-item"><a href="/coco/myPurchase"
						...
						</span> <!--Sidebar nav text--> <span class="sidebar-text">구매내역</span>
					</a></li>
					
					<li class="nav-item"><a href="/coco/myChart"
						class="nav-link d-flex align-items-center text-truncate "> <span
							class="sidebar-icon"> <span
								class="material-symbols-rounded"> monitoring </span>
						</span> <!--Sidebar nav text--> <span class="sidebar-text">매출관리</span>
					</a></li>
					
					<li class="nav-item">
						<a href="/coco/mentorList"
							class="nav-link d-flex align-items-center text-truncate "> 
						<span
							class="sidebar-icon"> <span
								class="material-symbols-rounded"> edit_note </span>
						</span> <!--Sidebar nav text--> <span class="sidebar-text">멘토신청</span>
					</a></li>
					
					
					<li class="nav-item">
						<a href="/coco/myCommunity"
							class="nav-link d-flex align-items-center text-truncate"> 
						<span
							class="sidebar-icon"> <span
								class="material-symbols-rounded"> public </span>
						</span> <!--Sidebar nav text--> <span class="sidebar-text">커뮤니티</span>
					</a></li>
				</ul>
			</nav>
