											...
											<c:choose>
												...
												<c:otherwise>
													<thead class="text-uppercase small text-body-secondary">
														<tr>
															<th onclick="sortTable(0)">프로젝트제목</th>
															<th onclick="sortTable(1)">업무제목</th>
															<th style="text-align:center;" onclick="sortTable(2)">상태코드</th>
															<th style="text-align:center;" onclick="sortTable(3)">우선순위</th>
															<th style="text-align:center; width:20%" onclick="sortTable(4)">진척도</th>
															<th style="text-align:center;" onclick="sortTable(5)">시작일</th>
															<th style="text-align:center;" onclick="sortTable(6)">종료일</th>
