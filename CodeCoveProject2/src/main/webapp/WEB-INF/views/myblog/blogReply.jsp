...
<div id="writeReply">
<form id="writeForm" method="post" class="form-inline" action="/blog/${memId}/reply/write">
	<!--<input type="text" name="postNum" value="${post.postNum }"/>  -->
	<sec:csrfInput/>
	<input type="hidden" name="postNum" value="${post.postNum}"/>
<%-- 	<input type="hidden" name="blReplyWriter" value="${loginId}"/> --%>
...
<form id="reWriteForm" method="post" class="form-inline" action="/blog/${memId}/reply/reWrite">
	<sec:csrfInput/>
	<input type="hidden" name="postNum" value="${post.postNum}"/>
	<input type="hidden" name="blReplyWriter" value="${loginId}"/>
...
<!-- 			</div> -->
<%-- 			<form id="upWriteForm"  method="post" class="form-inline" action="/blog/${memId}/reply/upWrite"> --%>
<%-- 				<sec:csrfInput/> --%>
...
// 	console.log("로그인된 아이디:  ", ${loginId } );
	...
	const loginMember = "${loginId}"; //로그인 회원아이디
	const urlMember = "${loginId}"; //url의 회원아이디
	...
	const delReplyURL="/blog/${memId}/reply/delReply"//댓글삭제 URL
