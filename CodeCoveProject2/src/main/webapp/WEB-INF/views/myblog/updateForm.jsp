...
<div id="FormBox">
	...
	<div>
		<div class="d-flex">
			<div id="tagArea"></div>
			<input type="text" id="tagInput" placeholder="태그입력 (단어입력 후 엔터)">
		</div>
	</div>
	<br>
	<div id="radio-box">
	...
	<form:form id="postForm" modelAttribute="mypost" method="post"
		...
		<form:input class="custom-file-input" path="thumbnail" type="hidden" />
...
if(myTags[0].replace("#","")!=""){
	...
	function attaDelBtn(el){
		...
		console.log("del:",delNum, delOrder);
    ...
    function DelTag(event){
    	...
    	myTags.splice(targetIdx,1);
    	console.log("삭제후배열="+myTags);
    }
...
//    		console.log(title);
      	...
      	if(title==""){
			...
			alert("카테고리를 선택해주세요.")
	      	...
	      	$("input[name='postTag']").attr("value", myTags.toString());
