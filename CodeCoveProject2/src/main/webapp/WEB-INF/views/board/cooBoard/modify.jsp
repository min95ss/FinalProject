...
<main class="container-fluid px-6">
	<div class="row align-items-center position-relative">
		<div class="col-sm-8">
			...
			<form class="row gx-4 mb-2" id="insertForm" action="/coco/cooBoard/update" method="post" enctype="multipart/form-data">
				<div class="row pb-2">
					<input type="text" name="cooTitle" class="form-control" value="${cooBoardVO.cooTitle }">
				</div>
				<div class="row">
					<textarea class="form-control" rows="20" id="cooContent" name="cooContent">${cooBoardVO.cooContent }</textarea>
				</div>
				<div class="row">
					<p class="text-sm"></p>
					<p class="text-sm"></p>
				...
				<input type="hidden" id="cooNm" name="cooNm" value="${cooBoardVO.cooNm }"/>
