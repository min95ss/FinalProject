...
<!-- 					<form id="expAppfrm" method="post" action="/coco/admin/getTotalReport"> -->
						...
						<div class="row d-flex my-1">
							...
							<div class="col-sm-3">
								<button class="btn btn-warning" onclick="window.open('/coco/mentoring/mentoringDetail?eprodNum=SLPO2305100001','CoCo-Admin Page','width=1280,height=800,location=no,status=no,scrollbars=yes');">확인</button>
							</div>
						</div>
